...
<html>
  <head>
    ...
    <style>
      ...
      position: relative;
      height: 300px;
      background-image: url("https://cdn.sqhk.co/sportcourtsouth/2016/12/9Jjg5dz/Connor-NTOC_027-resize.jpg");  
  ...
  <body>
    <div class="testbox">
      <form action="/">
        <div class="banner">
          <h1>Hoop Book Reservation Form</h1>
        </div>
        <div class="item">
